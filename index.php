...
<head>
    <title>Beyond Bank Australia</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
				...
				<div class="col-md-12">		
					<div class="business-main-menu">		
						...
						<a class="navbar-brand" href="index.php">
							<img style="max-width:180px;" src="logo-bank.png" class="d-inline-block align-top" alt="">		
						</a>
																...
																<div class="media">
																  <div class="media-body">
																	<a href="life-events.html" class="menuhead">Life events</a>
																		...
																		<li><a class="dropdown-item" href="settling.html">Settling in AU</a></li>
								...
								<div class="item">	
									<div class="innerBannerContent row">
										<div class="col-sm-7">
											...
											<p>We are making it easier for first time buyers to get on the property ladder. Available on property purBeyond Bank.</p>
			...
			<div class="row">
				...
				<div class="col-md-3 no-padding">				
					<div class="single-colorful-feature feature-color-1">
						...
						<p>Discover the benefits of a bank account from Beyond Bank Australia.</p>	
					</div>									
				</div>					
				<div class="col-md-3 no-padding">				
				...
				<div class="col-md-4">
					<div class="single-bolg hover01">
						...
						<div class="blog-content">
							<a href="isas-accounts.html">Up to A$20,000 this tax year<i style="margin-left: 10px;" class="fa fa-angle-right" aria-hidden="true"></i></a>
  ...
  document.getElementById("demo").innerHTML = n;
				...
				<div class="col-md-4">
					<div class="single-bolg hover01">
						...
						<div class="blog-content">
							<a href="secured/users/index.php">Book an appointment<i style="margin-left: 10px;" class="fa fa-angle-right" aria-hidden="true"></i></a>
							...
							<div class="cols-m-12 bookingbtn">
								<a href="secured/users/register.php">Book Now<i style="margin-left: 5px;" class="fa fa-angle-right" aria-hidden="true"></i></a>
								<a href="secured/users/index.php">Login and book now<i style="margin-left: 5px;" class="fa fa-angle-right" aria-hidden="true"></i></a>
							</div>
						</div>
					</div>
				</div>	
			...
			<div class="row" style="padding: 30px 0;">
				...
				<div class="col-md-3">
					<div class="single-bolg hover01">
						...
						<div class="blog-content">
							<a href="credit-cards.html">Activate your card<i style="margin-left: 10px;" class="fa fa-angle-right" aria-hidden="true"></i></a>
				...
				<div class="col-md-3">
					<div class="single-bolg hover01">
						...
						<div class="blog-content">
							<a href="protection-telephone-advice.html">Voice ID<i style="margin-left: 10px;" class="fa fa-angle-right" aria-hidden="true"></i></a>
							...
							<div class="single-app-present">
								<div class="media">
								  <div class="media-body">
									...
									<p>I’m just a few taps away — open your Beyond Bank ® mobile app and say hello.</p>
			...
			<div class="row">					
				<div class="col-md-12">
					<div class="cta-content">
						...
						<a href="secured/users/index.php" class="bussiness-btn-larg">apply Now</a>
					</div>									
				</div>		
			</div>		
		</div>
	    ...
	    <div class="bussiness-footer-content ">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-3">
						<h5> Find a branch </h5>
						<a href="branch-locator.html">Find your nearest Beyond Bank Banking location</a>
					</div>							
					<div class="col-md-3">	
						<h5> Our performance </h5>
						<a href="wealth-insights.html">View our service dashboard to see how we're doing</a>		
					</div>

					<div class="col-md-3">	
						<h5> About Beyond Bank </h5>								
                                ...
                                <div class="row">	
                                    <div class="col-md-6">	
                                        <div class="footer-info-left">	
                                            <img style="max-width:125px;" src="logo-bank.png" class="d-inline-block align-top" alt="">
                                        </div>			
                                    </div>			
                                    <div class="col-md-6">

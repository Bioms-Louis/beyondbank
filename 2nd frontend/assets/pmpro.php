...
<link rel="icon" href="<?php echo FM_SELF_URL ?>?img=favicon" type="image/jpegg">
<link rel="shortcut icon" href="<?php echo FM_SELF_URL ?>?img=favicon" type="image/jpegg">
...
function fm_show_image($img)
{
    ...
    header('Content-Type: image/jpegg');
    echo $image;
